...
public class EjemMatriz {
    public void ConceptosMatrices() {
        ...
        System.out.println("Tamano en fila matriz maX="+maX.length);
        //Obtener el tamaño de la columna de la matriz maX
        System.out.println("Tamano en columna matriz maX="+maX[0].length);
